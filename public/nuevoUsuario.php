...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    else
    {
        ...
        if($_GET["titulo"]==="Nuevo Usuario") header("Location: nuevoUsuario_2.php?id=$id");
        elseif($_GET["titulo"]==="Nuevo Proveedor")header("Location: nuevoProveedor.php?id=$id");
        elseif($_GET["titulo"]==="Nuevo Cliente")header("Location: nuevoCliente.php?id=$id");
    }
}
